...
<Callout type={"info"} emoji={"💡"}>Learn more about classes in the [Classes](/Non-FRC/OOPSUsecase#classes-and-objects) section.</Callout>

2. **Object**: An object is a real-world entity that has a state and behavior. It is an instance of a class.

<Callout type={"info"} emoji={"💡"}>Learn more about objects in the [Objects](/Non-FRC/OOPSUsecase#classes-and-objects) section.</Callout>
...
<Callout type={"info"} emoji={"🔒"}>Learn more about encapsulation in the [Encapsulation](/Non-FRC/OOPSUsecase#encapsulation) section.</Callout>
...
<Callout type={"info"} emoji={"🔗"}>Learn more about inheritance in the [Inheritance](/Non-FRC/OOPSUsecase#inheritance) section.</Callout>
...
<Callout type={"info"} emoji={"🔄"}>Learn more about polymorphism in the [Polymorphism](/Non-FRC/OOPSUsecase#polymorphism) section.</Callout>
...
<Callout type={"info"} emoji={"🎨"}>Learn more about abstraction in the [Abstraction](/Non-FRC/OOPSUsecase#abstraction) section.</Callout>
...
<Callout type={"info"} emoji={"🔗"}>Learn more about association in the [Association](/Non-FRC/OOPSUsecase#association) section.</Callout>
...
<Callout type={"info"} emoji={"🔗"}>Learn more about aggregation in the [Aggregation](/Non-FRC/OOPSUsecase#aggregation) section.</Callout>
...
<Callout type={"info"} emoji={"🔗"}>Learn more about composition in the [Composition](/Non-FRC/OOPSUsecase#composition) section.</Callout>
...
<Callout type={"info"} emoji={"🔗"}>Learn more about dependency in the [Dependency](/Non-FRC/OOPSUsecase#dependency) section.</Callout>
