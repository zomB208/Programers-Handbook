...
```
<Callout emoji="📝">
    <p>This is because Python prioritizes local variables within a function before considering global variables. Assigning a global variable to a local variable within a function can enhance the efficiency of your code.</p>
</Callout>
